...
"""
PVT-v2 Backbone
Reference: Wang et al., "PVT v2: Improved Baselines with Pyramid Vision Transformer",
...
class Mlp(nn.Module):
    """MLP with a depth-wise conv (used in PVT-v2 blocks)."""
...
class Attention(nn.Module):
    """Efficient self-attention with Spatial-Reduction (SRA)."""
...
class Block(nn.Module):
    """Transformer encoder block used in PVT-v2."""
